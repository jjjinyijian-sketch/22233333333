        ...
        <div className="flex gap-2">
          ...
          {uploadedPhotos.length > 0 && (
            <button 
              ...
              className="px-5 py-3 md:px-6 md:py-3 bg-white/10 hover:bg-white/20 border border-white/30 rounded-full text-white/70 text-xs md:text-sm transition-all backdrop-blur-md shadow-[0_0_20px_rgba(255,255,255,0.1)] active:scale-95 flex items-center justify-center"
            >
